...
class Dashboard extends Component {
  ...
  componentDidMount() {
    ...
    windowListeners(
      albumScrollPayload,
      actionPayload(this.keyRight, this.keyLeft),
  ...
  scrollAlbumRight = () => {
    ...
    this.setState(prevState => {
      return {
        ...
        translate: prevState.translate + -345
      };
    });
  };
    ...
    return (
      <div>
        ...
        >
          ...
          <div
            style={{ transform: "translateY(-270px)", zIndex: 5, height: 0 }}
          >
            {this.state.albums.map((el, i) => {
              return <Dots key={i} index={i} currentIndex={this.state.index} />;
            })}
          </div>
        </div>
      </div>

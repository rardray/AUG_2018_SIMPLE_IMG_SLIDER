...
const Routes = (props) => {
    const { loginUser, history, token, user, windowHeight } = props
    return (
        <div>
        <Route exact path = '/login' render = {(props) => 
         ...
         <Route exact path = '/dashboard' render = {(props) => <Dashboard {...props} windowHeight = {windowHeight} token = {token} user = {user}/>} />
